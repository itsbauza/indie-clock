    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-emerald-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4 font-space-grotesk">
            Welcome to{" "}
          ...
          <p className="text-lg text-gray-600">
            Sign in to track your GitHub contributions and light up your desk
          </p>
        </div>
          ...
          {providers &&
            Object.values(providers).map((provider: any) => (
              <button
                ...
                disabled={isLoading}
                className="group relative w-full flex justify-center items-center py-4 px-6 border border-gray-300 rounded-xl shadow-lg bg-white text-lg font-semibold text-gray-700 hover:bg-gray-50 hover:shadow-xl hover:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-[1.02]"
              >
                {isLoading ? (
...
export default function SignIn() {
  return (
    <Suspense fallback={
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-emerald-50 relative overflow-hidden">
        {/* Enhanced decorative elements */}
        <div className="absolute -top-56 -left-56 h-[16rem] md:h-[32rem] w-[16rem] md:w-[32rem] rounded-full bg-indigo-200 opacity-30 blur-3xl"></div>
        <div className="absolute -bottom-56 -right-56 h-[16rem] md:h-[32rem] w-[16rem] md:w-[32rem] rounded-full bg-amber-100 opacity-30 blur-3xl"></div>
        <div className="absolute top-1/4 right-1/4 h-[8rem] md:h-[16rem] w-[8rem] md:w-[16rem] rounded-full bg-emerald-200 opacity-20 blur-2xl"></div>
